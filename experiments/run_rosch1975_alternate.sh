...
do
    ...
    python ../python/taxonomic_verification.py --model ${model} --device cuda:1 --batchsize 50 --dataset ../data/rosch1975/rosch1975_alternate.csv
done
...
do
    echo "Running experiments for ${model}!"
    python ../python/taxonomic_verification.py --model ${model} --device cuda:1 --lmtype incremental --batchsize 50 --dataset ../data/rosch1975/rosch1975_alternate.csv
done

echo "Running experiments on ngram language models"

python ../python/ngram_priming.py --dataset ../data/rosch1975/rosch1975_alternate.csv --stimulusonly 0 --continuous 1