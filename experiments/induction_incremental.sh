...
do
    ...
    python ../python/contextual_priming.py --model ${model} --stimulusonly --shuffled --control --device cuda:0 --lmtype incremental --batchsize 50 --dataset ../data/premiseconclusion.csv
